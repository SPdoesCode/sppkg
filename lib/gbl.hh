...
namespace global {
    ...
    inline int addGlobalPkg(pkgdef::Package pkg);
    inline int rmGlobalPkg(pkgdef::Package pkg);
    inline bool inGlobal(pkgdef::Package pkg);
    inline gbldef::Global getGlobal();
    ...
    inline gbldef::Global getGlobal() {
        ...
        try {
            ...
            std::cout << "ERROR: Couldnt parse package file " << err.description() << " at " << err.source().begin << "\n";
            exit(1);
        }
